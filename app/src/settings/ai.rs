...
impl ThinkingDisplayMode {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ThinkingDisplayMode::ShowAndCollapse => "显示后折叠",
            ThinkingDisplayMode::AlwaysShow => "始终显示",
            ThinkingDisplayMode::NeverShow => "不显示",
        }
    }

    pub fn command_palette_description(&self) -> &'static str {
        match self {
            ThinkingDisplayMode::ShowAndCollapse => "设置智能体思考过程显示方式：显示后折叠",
            ThinkingDisplayMode::AlwaysShow => "设置智能体思考过程显示方式：始终显示",
            ThinkingDisplayMode::NeverShow => "设置智能体思考过程显示方式：不显示",
        }
    }
